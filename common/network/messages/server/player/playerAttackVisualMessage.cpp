...
PlayerAttackVisualMessage::PlayerAttackVisualMessage(uint32_t attackerId,
                                                     uint32_t targetId,
...
uint32_t PlayerAttackVisualMessage::getAttackerId() const { return attackerId; }
uint32_t PlayerAttackVisualMessage::getTargetId() const { return targetId; }
PlayerAttackVisualType PlayerAttackVisualMessage::getVisualType() const { return visualType; }
const std::string &PlayerAttackVisualMessage::getEffectId() const { return effectId; }
