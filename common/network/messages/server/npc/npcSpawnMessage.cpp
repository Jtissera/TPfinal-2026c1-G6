...
NpcSpawnMessage::NpcSpawnMessage(
    uint32_t npcId,
    NpcType type,
    std::string name,
    uint16_t x,
...
uint32_t NpcSpawnMessage::getNpcId() const {
    return npcId;
}

NpcType NpcSpawnMessage::getType() const {
    return type;
}

const std::string& NpcSpawnMessage::getName() const {
    return name;
}

uint16_t NpcSpawnMessage::getX() const {
    return x;
}

uint16_t NpcSpawnMessage::getY() const {
    return y;
}

uint16_t NpcSpawnMessage::getHp() const {
    return hp;
}

uint16_t NpcSpawnMessage::getHpMax() const {
    return hpMax;
}
